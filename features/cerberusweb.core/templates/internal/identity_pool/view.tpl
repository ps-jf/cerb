{$view_context = CerberusContexts::CONTEXT_IDENTITY_POOL}
...
<input type="hidden" name="module" value="identity_pool">
	...
	<tbody style="cursor:pointer;">
		...
		{foreach from=$view->view_columns item=column name=columns}
			...
			<td>
				...
				<a href="{devblocks_url}c=profiles&type=identity_pool&id={$result.i_id}-{$result.i_name|devblocks_permalink}{/devblocks_url}" class="subject">{$result.i_name}</a>
